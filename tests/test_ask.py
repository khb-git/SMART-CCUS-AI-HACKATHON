...
def test_ask_question_retrieves_packages_and_builds_answer(monkeypatch):
    ...
    assert calls["reference_query"] == "How do applicants monitor injection pressure?"
    assert calls["permit_query"] == "How do applicants monitor injection pressure?"
    ...
    assert answer.question == "How do applicants monitor injection pressure?"
